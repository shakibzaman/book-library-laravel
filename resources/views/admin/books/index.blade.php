    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.books.create") }}">
                {{ trans('global.add') }} {{ trans('cruds.books.title_singular') }}
            </a>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.books.title_singular') }} {{ trans('global.list') }}
        </div>
            ...
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Role">
                    ...
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.books.fields.id') }}
                        </th>
                        <th>
                            {{ trans('cruds.books.fields.name') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
